...
import { Basket } from '../user/enities/basket.entity';
import { Repository } from 'typeorm';
import { v4 as uuidv4 } from 'uuid';

import { BasketDto } from '../user/dto/basket.dto';
import { BasketTotalDto } from '../user/dto/basket-total.dto';

@Injectable()
export class OrderService {
  constructor() {} // private readonly basketRepository: Repository<Basket>, // @InjectRepository(Basket)
